...
The numerical summary shows that c52 has more Vitc than c39
...
The P value is so small we reject the hypothesis. This means there must be a difference. 
...
The data we collected from the graph was that VitC content in c52 was higher on the y-axis than the VitC content in c39.  
The numerical summary was that VitC content in c39 had a median of 51.5 and c52 had a median of 64.4.  
We conclude that VitC content based on c52 is greater than VitC content based on c39. 
